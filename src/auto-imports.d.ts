...
declare global {
  ...
  const snackbarStore: typeof import('./store/snackbar')['snackbarStore']
  const statusModule: typeof import('./store/status')['statusModule']
  const statusStore: typeof import('./store/status')['statusStore']
